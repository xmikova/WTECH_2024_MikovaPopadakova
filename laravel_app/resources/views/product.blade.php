            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="description">
                        @auth
                            @if(Auth::user() && Auth::user()->role === 'admin')
                                <form action="{{ route('product.update', ['product' => $product->id]) }}" method="POST" class="center-content">
                                    @csrf
                                    @method('PUT')
                                    <h3 class="mb-3">Úprava produktu:</h3>
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Názov produktu:</label>
                                        <input type="text" class="form-control no-margin" id="name" name="name" value="{{ $product->name }}">
                                    </div>
                                    <div class="mb-3">
